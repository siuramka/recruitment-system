...
namespace RecruitmentSystem.DataAccess.Migrations
{
    ...
    [Migration("20240317153948_evaluations_applicaiton_relation")]
    partial class evaluations_applicaiton_relation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RecruitmentSystem.Domain.Models.Review", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RecruitmentSystem.Domain.Models.Review", b =>
                {
                    b.HasOne("RecruitmentSystem.Domain.Models.Application", null)
                        .WithOne("Review")
                        .HasForeignKey("RecruitmentSystem.Domain.Models.Review", "ApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RecruitmentSystem.Domain.Models.Company", null)
                        .WithMany("Reviews")
                        .HasForeignKey("CompanyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
